...
export default function Filter() {
  return <Select>
    <SelectTrigger className="max-w-max outline-0 flex flex-row gap-2 bg-green-200 items-center justify-center p-2 min-h-fit g-4 rounded-s-md text-violet-500 text-sm hover:bg-red-300" aria-label="Filtro">
