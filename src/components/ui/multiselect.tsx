...
interface MultiSelectProps
  ...
  /**
   * The text to show to express the "Select all" option.
      ...
      >
        <PopoverTrigger asChild>
          <Button
            ...
            className={cn(
              "flex w-full p-1 rounded-md border min-h-10 h-4 items-center justify-between bg-inherit hover:bg-inherit",
              className
            )}
          >
            {selectedValues.length > 0 ? (
              ...
              <div className="flex items-center justify-between w-full mx-auto">
                <span className="font-normal text-white mx-3">
                  {placeholder}
                </span>
